...
public class AnimalController {
  ...
  public ResponseEntity<?> createAnimal(
    ...
    if (file.isEmpty()) {
      ErrorDto errorDto = new ErrorDto();
      errorDto.setCause("File is empty.");
      errorDto.setMessage("File is empty.");
      errorDto.setCode(400);
      return ResponseEntity.status(400).body(errorDto);
    }
    if (info.isEmpty()) {
      ErrorDto errorDto = new ErrorDto();
      errorDto.setCause("Info is empty.");
      errorDto.setMessage("Info is empty.");
      errorDto.setCode(400);
      return ResponseEntity.status(400).body(errorDto);
    }
    if (name.isEmpty()) {
      ErrorDto errorDto = new ErrorDto();
      errorDto.setCause("Name is empty.");
      errorDto.setMessage("Name is empty.");
      errorDto.setCode(400);
      return ResponseEntity.status(400).body(errorDto);
    }
    if (username.isEmpty()) {
      ErrorDto errorDto = new ErrorDto();
      errorDto.setCause("Username is empty.");
      errorDto.setMessage("Username is empty.");
      errorDto.setCode(400);
      return ResponseEntity.status(400).body(errorDto);
    }
    if (name.length() < 3) {
      ErrorDto errorDto = new ErrorDto();
      errorDto.setCause("Minimum length of name is 3 symbols.");
      errorDto.setMessage("Minimum length of name is 3 symbols.");
      errorDto.setCode(400);
      return ResponseEntity.status(400).body(errorDto);
    }
    if (info.length() < 3) {
      ErrorDto errorDto = new ErrorDto();
      errorDto.setCause("Minimum length of info is 3 symbols.");
      errorDto.setMessage("Minimum length of info is 3 symbols.");
      errorDto.setCode(400);
      return ResponseEntity.status(400).body(errorDto);
    }
